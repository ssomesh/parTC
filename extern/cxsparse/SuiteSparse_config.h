...
// SuiteSparse-wide parameters are placed in this struct.  It is meant to be an
// extern, globally-accessible struct.  It is not meant to be updated
...
#define SUITESPARSE_DATE "Dec 23, 2022"
...
#define SUITESPARSE_LAPACK_ZLARF    SUITESPARSE_BLAS ( zlarf  , ZLAR   )
